...
class AffixGroupEditor(_AffixGroupPoolsMixin, _AffixGroupControlsMixin, QWidget):
    ...
    def setup_ui(self) -> None:
        ...
        general_form.addRow(tr("Item Types:"), item_type_layout)
        ...
        general_form.addRow(tr("Rarities:"), rarity_layout)
        ...
        general_form.addRow(tr("Minimum Power:"), self.min_power)
        ...
        self.auto_sync_checkbox = QCheckBox(tr("Auto Sync"))
        ...
        self.affix_pool_container = Container(tr("Affix Pool"))
        ...
        self.inherent_pool_container = Container(tr("Inherent Pool"))
