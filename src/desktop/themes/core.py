...
QLabel#dashboard-section-heading {{ color: @label@; font-size: 13px; font-weight: bold; padding: 2px 0; }}
QLabel#equipment-status {{ color: @text@; padding: 8px 4px; font-size: 12px; }}
QTabWidget#dashboard-detail-tabs::pane {{ border: 0; border-top: 1px solid @border@; }}
